...
public class PirexLoadingTab extends JPanel 
{
	...
	private JTextField jtfFilePath = new JTextField(78), jtfTitle = new JTextField(43), jtfAuthor = new JTextField(40);
	...
	PirexLoadingTab()
	{
		...
		jcbFileType.setPrototypeDisplayValue((String)"QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ"); //set default width
